...
_BASE_GOLDEN = (
    Path(__file__).resolve().parents[2] / "tensormap_and_ringbuffer" / "paged_attention" / "golden.py"
)
_SPEC = spec_from_file_location("tmr_unmodified_paged_attention_golden", _BASE_GOLDEN)
